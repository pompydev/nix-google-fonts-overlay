...
stdenv.mkDerivation rec {
  ...
  version = "2022-05-13-115651";

  phases = [ "unpackPhase" "installPhase" ];

  srcs = [
    (fetchurl {
      url = "https://github.com/google/fonts/blob/dfad63d07a2f149aa33dc3a74016328551f77499/ofl/charissil/CharisSIL-Regular.ttf?raw=true";
      name = "CharisSIL-Regular.ttf";
      sha256 = "346337374aa347d64ee015b26d441f1970d8631914e2f3941b00e1c4761e28c5";
    })
    (fetchurl {
      url = "https://github.com/google/fonts/blob/dfad63d07a2f149aa33dc3a74016328551f77499/ofl/charissil/CharisSIL-Italic.ttf?raw=true";
      name = "CharisSIL-Italic.ttf";
      sha256 = "e776e2961117b39cf924c0139de01748a77b2fcb99c437b2c77bdd9401606c13";
    })
    (fetchurl {
      url = "https://github.com/google/fonts/blob/dfad63d07a2f149aa33dc3a74016328551f77499/ofl/charissil/CharisSIL-Bold.ttf?raw=true";
      name = "CharisSIL-Bold.ttf";
      sha256 = "68460d2b76c8f781b49f9168f2c7dc3c9f7b788a3a1b8f267c5fa6bb47d5c64d";
    })
    (fetchurl {
      url = "https://github.com/google/fonts/blob/dfad63d07a2f149aa33dc3a74016328551f77499/ofl/charissil/CharisSIL-BoldItalic.ttf?raw=true";
