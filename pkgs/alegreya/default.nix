...
stdenv.mkDerivation rec {
  ...
  installPhase = ''
     install -Dm644 'Alegreya[wght].ttf' $out/share/fonts/truetype/'Alegreya[wght].ttf'
     install -Dm644 'Alegreya-Italic[wght].ttf' $out/share/fonts/truetype/'Alegreya-Italic[wght].ttf'
  '';
