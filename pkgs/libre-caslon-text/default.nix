...
stdenv.mkDerivation rec {
  ...
  srcs = [
    ...
    (fetchurl {
      ...
      name = "LibreCaslonText-Italic[wght].ttf";
  ...
  installPhase = ''
     install -Dm644 'LibreCaslonText[wght].ttf' $out/share/fonts/truetype/'LibreCaslonText[wght].ttf'
     install -Dm644 'LibreCaslonText-Italic[wght].ttf' $out/share/fonts/truetype/'LibreCaslonText-Italic[wght].ttf'
  '';
