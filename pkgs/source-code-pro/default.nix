...
stdenv.mkDerivation rec {
  ...
  srcs = [
    ...
    (fetchurl {
      ...
      name = "SourceCodePro-Italic[wght].ttf";
  ...
  installPhase = ''
     install -Dm644 'SourceCodePro[wght].ttf' $out/share/fonts/truetype/'SourceCodePro[wght].ttf'
     install -Dm644 'SourceCodePro-Italic[wght].ttf' $out/share/fonts/truetype/'SourceCodePro-Italic[wght].ttf'
  '';
