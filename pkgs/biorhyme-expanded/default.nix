...
stdenv.mkDerivation rec {
  name = "biorhyme-expanded-${version}";
  ...
  srcs = [
    (fetchurl {
      url = "https://github.com/google/fonts/blob/c781e48f571fe26740a9814c0461064628cbd175/ofl/biorhymeexpanded/BioRhymeExpanded-ExtraLight.ttf?raw=true";
      name = "BioRhymeExpanded-ExtraLight.ttf";
      sha256 = "16ba12fa8b94712383e5a4eac51d11addba2a8ce44a0c239ee13583cd7c32fc1";
    })
    (fetchurl {
      url = "https://github.com/google/fonts/blob/c781e48f571fe26740a9814c0461064628cbd175/ofl/biorhymeexpanded/BioRhymeExpanded-Light.ttf?raw=true";
      name = "BioRhymeExpanded-Light.ttf";
      sha256 = "396a934bcfcd29009432f281c5be6ee2d1ed9552ca45eae509af3f9076d511cb";
    })
    (fetchurl {
      url = "https://github.com/google/fonts/blob/c781e48f571fe26740a9814c0461064628cbd175/ofl/biorhymeexpanded/BioRhymeExpanded-Regular.ttf?raw=true";
      name = "BioRhymeExpanded-Regular.ttf";
      sha256 = "e75a7c996c8884d3d26c0823e7cfbf3cf404d27a36ddff715f6dfd95389affa7";
    })
    (fetchurl {
      url = "https://github.com/google/fonts/blob/c781e48f571fe26740a9814c0461064628cbd175/ofl/biorhymeexpanded/BioRhymeExpanded-Bold.ttf?raw=true";
      name = "BioRhymeExpanded-Bold.ttf";
      sha256 = "b90136544a46250d2c366d8fdb3268419f0433ba6a6c96998baafe0d17319a77";
    })
    (fetchurl {
      url = "https://github.com/google/fonts/blob/c781e48f571fe26740a9814c0461064628cbd175/ofl/biorhymeexpanded/BioRhymeExpanded-ExtraBold.ttf?raw=true";
