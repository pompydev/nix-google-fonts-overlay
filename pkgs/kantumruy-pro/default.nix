...
stdenv.mkDerivation rec {
  ...
  srcs = [
    ...
    (fetchurl {
      ...
      name = "KantumruyPro-Italic[wght].ttf";
  ...
  installPhase = ''
     install -Dm644 'KantumruyPro[wght].ttf' $out/share/fonts/truetype/'KantumruyPro[wght].ttf'
     install -Dm644 'KantumruyPro-Italic[wght].ttf' $out/share/fonts/truetype/'KantumruyPro-Italic[wght].ttf'
  '';
