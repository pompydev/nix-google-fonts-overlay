...
stdenv.mkDerivation rec {
  ...
  installPhase = ''
     install -Dm644 'EBGaramond[wght].ttf' $out/share/fonts/truetype/'EBGaramond[wght].ttf'
     install -Dm644 'EBGaramond-Italic[wght].ttf' $out/share/fonts/truetype/'EBGaramond-Italic[wght].ttf'
  '';
