...
stdenv.mkDerivation rec {
  ...
  srcs = [
    ...
    (fetchurl {
      ...
      name = "Brygada1918-Italic[wght].ttf";
  ...
  installPhase = ''
     install -Dm644 'Brygada1918[wght].ttf' $out/share/fonts/truetype/'Brygada1918[wght].ttf'
     install -Dm644 'Brygada1918-Italic[wght].ttf' $out/share/fonts/truetype/'Brygada1918-Italic[wght].ttf'
  '';
