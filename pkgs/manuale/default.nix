...
stdenv.mkDerivation rec {
  ...
  installPhase = ''
     install -Dm644 'Manuale[wght].ttf' $out/share/fonts/truetype/'Manuale[wght].ttf'
     install -Dm644 'Manuale-Italic[wght].ttf' $out/share/fonts/truetype/'Manuale-Italic[wght].ttf'
  '';
