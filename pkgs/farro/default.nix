...
stdenv.mkDerivation rec {
  ...
  srcs = [
    (fetchurl {
      url = "https://github.com/google/fonts/blob/c781e48f571fe26740a9814c0461064628cbd175/ofl/farro/Farro-Light.ttf?raw=true";
      name = "Farro-Light.ttf";
      sha256 = "0e66c58243c6f4f7b10ea268b52687c627d658d607493865aee474acf2b5d7fb";
    })
    (fetchurl {
      url = "https://github.com/google/fonts/blob/c781e48f571fe26740a9814c0461064628cbd175/ofl/farro/Farro-Regular.ttf?raw=true";
      name = "Farro-Regular.ttf";
      sha256 = "eed5807e2779c1fba1a1627a1d34b0450e4fc6a87200522e2f3e3f617221c82b";
    })
    (fetchurl {
      url = "https://github.com/google/fonts/blob/c781e48f571fe26740a9814c0461064628cbd175/ofl/farro/Farro-Medium.ttf?raw=true";
      name = "Farro-Medium.ttf";
      sha256 = "a5447bf5122e9a9804007c56353653ee7f223008120d428a5176a028ec697c80";
    })
    (fetchurl {
      url = "https://github.com/google/fonts/blob/c781e48f571fe26740a9814c0461064628cbd175/ofl/farro/Farro-Bold.ttf?raw=true";
      name = "Farro-Bold.ttf";
