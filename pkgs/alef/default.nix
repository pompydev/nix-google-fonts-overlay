...
stdenv.mkDerivation rec {
  ...
  srcs = [
    (fetchurl {
      url = "https://github.com/google/fonts/blob/973a8934ba60f3a32a83617dce24edc3605fe3bb/ofl/alef/Alef-Regular.ttf?raw=true";
      name = "Alef-Regular.ttf";
      sha256 = "a32adcc953ac356906901778460083dc207d4560cb586fd9ea24ec5b186969ed";
    })
    (fetchurl {
      url = "https://github.com/google/fonts/blob/973a8934ba60f3a32a83617dce24edc3605fe3bb/ofl/alef/Alef-Bold.ttf?raw=true";
      name = "Alef-Bold.ttf";
